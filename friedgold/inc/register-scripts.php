...
function ti_theme_scripts(){
	...
	// Font Awesome Icons
	wp_enqueue_style('awesome', get_stylesheet_directory_uri() . '/css/font-awesome.min.css', 'style');
	...
	// Classie
	wp_enqueue_script( 'classie', get_template_directory_uri() . '/js/classie.js', 'jquery', '2.1', true );
